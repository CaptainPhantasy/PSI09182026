...
// Export an isolated editing preview. Original application files and API routes
// remain intact in this repository and in the original Git history.
...
console.log(`Sites editing preview exported to ${output}`);
