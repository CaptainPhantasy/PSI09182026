    ...
    <section id="what-we-find" className="psi alt">
      <div className="container">
          ...
          {PIPE_ISSUES?.map((issue, index) => (
            ...
            >
              {issue.image.endsWith(".png") && <div className="still">
                <Image
                  src={issue.image}
                  alt={t(`Illustration: ${issue.description}`)}
                  fill
                  loading="eager"
        ...
        <div className="findings-foot">
          <p>
            <T>Images shown here are generated illustrations of possible conditions, not PSI job photographs. Your own inspection recording is the evidence for your property.</T>
          </p>
        </div>
      </div>
    </section>
