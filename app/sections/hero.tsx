          ...
          >
            <div style={{ position: 'relative', width: '100%', height: '100%', minHeight: '400px', borderRadius: '16px', overflow: 'hidden' }}>
              <Image
                ...
                alt="Illustrative sewer camera inspection scene"
                fill
            ...
            <p className="absolute top-3 left-3 right-3 bg-white/95 text-gray-800 text-sm p-2 rounded">Illustrative image; not a documented PSI job.</p>
