...
import ContactForm from '@/components/inspection-request-form'
...
export const metadata: Metadata = {
  title: 'Book an Inspection | Sewer, Drain & Locating Requests | PSI',
  description: 'Tell PSI your address, concern and available access. We confirm the inspection scope, price and appointment. Central Indiana sewer, drain and locating requests.',
  openGraph: {
    title: 'Book Your Sewer Inspection | Precision Sewer Inspections Indianapolis',
    description: 'Request a Central Indiana inspection. We confirm access, scope, price and availability before scheduling.',
  },
  alternates: {
    canonical: '/contact',
  },
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <p className="text-xl text-primary-200">
                <T>Tell us the address, concern and available access. We will help you choose the right starting point.</T>
              </p>
            </div>
          </div>
        </section>
              ...
              <div className="lg:col-span-3">
                <div className="bg-white rounded-2xl shadow-sm p-6 md:p-8">
                  ...
                  <p className="text-gray-600 mb-6">
                    <T>A standard cleanout-access sewer scope is $159. Other access methods, locating, multiple lines and pump systems may need a different scope. We agree on the price before work begins.</T>
                  </p>
                  <ContactForm />
                </div>
              </div>
