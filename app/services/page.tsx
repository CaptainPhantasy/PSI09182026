                  ...
                  >
                    ...
                    {service?.image && (
                      <div className={`relative aspect-[4/3] rounded-2xl overflow-hidden shadow-lg ${index % 2 === 1 ? 'lg:order-1' : ''}`}>
                        <Image
                          src={service.image}
                          alt="Illustrative inspection scene; not a documented PSI job"
                          fill
                          loading="eager"
                          sizes="(max-width: 1024px) 100vw, 50vw"
                          className="object-cover"
                        />
                        <p className="absolute bottom-3 left-3 right-3 bg-white/95 p-2 text-sm text-gray-800 rounded">Illustrative image; not a documented PSI job.</p>
                      </div>
                    )}
                  </div>
                )
            ...
            <div className="grid md:grid-cols-2 gap-8 mt-10">
              <div className="bg-white rounded-2xl shadow-lg p-8 flex flex-col items-center text-center">
                <div className="relative w-40 h-40 mb-6">
                  <Image src="/images/jetting-logo.png" alt="Precision Sewer Inspections hydro jetting" fill loading="eager" sizes="160px" className="object-contain" />
                </div>
              ...
              <div className="bg-white rounded-2xl shadow-lg p-8 flex flex-col items-center text-center">
                <div className="relative w-40 h-40 mb-6">
                  <Image src="/images/pls_logo.png" alt="Precision Location Services private utility locating" fill loading="eager" sizes="160px" className="object-contain" />
                </div>
