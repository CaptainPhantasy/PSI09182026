        ...
        <section className="py-12 bg-white">
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto">
              ...
              <p className="text-gray-700 mb-8">Inspection requests are delivered to PSI through FormSubmit. We use the details you submit to discuss the scope and appointment. No payment is collected by this request form. Mention an existing report or job reference and we will arrange appropriate sharing of inspection media.</p>
              {/* Section 1 */}
              <div className="mb-10">
